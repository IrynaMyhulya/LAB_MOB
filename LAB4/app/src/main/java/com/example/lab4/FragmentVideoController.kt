...
import kotlinx.android.synthetic.main.fragment_video_controller.*

class FragmentVideoController : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_video_controller, container, false);
